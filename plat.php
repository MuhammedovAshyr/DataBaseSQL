...
<body>
    ...
    <div class="table_flex">
        <div class="sp_flex">
            <div>Всего записей: <b>
                    <?php
                    $ret = mysqli_query($conn, "SELECT count(*) as scount_ls FROM `tb_payments` ");
                    $row = mysqli_num_rows($ret);
                    if ($row > 0) {
                        while ($row = mysqli_fetch_array($ret)) {
                            $scount_ls = $row["scount_ls"];
            ...
            <div>
                <div class="col-sm-6">
                    <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons"></i> <span>Добавить платеж</span></a>
                </div>
            </div>
        </div>
        <div>
                            ...
                            <tr id="<?php echo $row["id_ls"]; ?>">
                                ...
                                <td>
                                    <a href="#editEmployeeModal" class="edit" data-toggle="modal">
                                        <i class="material-icons update_plat" 
                                        data-toggle="tooltip" 
                                    ...
                                    <a href="#deleteEmployeeModal" class="delete-plat" 
                                        data-idls ="<?php echo $row["id_ls"]; ?>" 
                                        data-smonth = "<?php echo $row["smonth"]; ?>" 
                                        data-syear = "<?php echo $row["syear"]; ?>" 
                ...
                <div class="modal-content">
                    <form id="user_form">
                        <div class="modal-header">
                            <h4 class="modal-title">Добавить новый платеж</h4>
                        ...
                        <div class="modal-body">                            
                            ...
                            <div class="form-group">
                                <label>№ Л/С:</label>
                                    <?php     
                                    // вывод 
                                    echo '<select name="id_ls" id="id_ls_list" class="form-control"  onchange="val(this)" data-table="tb_payments"><option>--- Выберите Л/С ---</option>';
                        ...
                        <div class="modal-footer">
                            <input type="hidden" value="31" name="type">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Отмена">
                            <button type="button" class="btn btn-success" id="btn-add-plat">Добавить</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="update_form">
                        ...
                        <div class="modal-footer">
                            <input type="hidden" value="32" name="type">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Отмена">
                            <button type="button" class="btn btn-info" id="update-plat">Обновить</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Отмена">
                            <button type="button" class="btn btn-danger" id="delete-plat">Удалить</button>
                        </div>
                    </form>
                </div>
            </div>
